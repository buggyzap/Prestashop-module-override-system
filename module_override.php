...
class Module_Override extends Module
{
    ...
    public function createOriginal($item, $dest, $module_path)
    {
        $original_source = $dest.str_replace($module_path, "", $item);
        file_put_contents($item.".original", file_get_contents($original_source));
    }
            ...
            $iterator = new \RecursiveIteratorIterator(
                ...
                if($item->isDir()){
                    ...
                    if($new_overriden){
                        ...
                        if(!$this->existOriginal($item)) $this->createOriginal($item, $dest, $module_path);
                    }else{
                        if(strpos($item, ".original") === false) continue;
